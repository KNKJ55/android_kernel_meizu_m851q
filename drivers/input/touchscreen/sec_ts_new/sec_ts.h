...
#define SEC_TS_NVM_OFFSET_PRESSURE_DELTA_CAL_COUNT	(SEC_TS_NVM_OFFSET_PRESSURE_BASE_CAL_COUNT + 1)	/*36*/
#define SEC_TS_NVM_OFFSET_PRESSURE_STRENGTH_INDEX	(SEC_TS_NVM_OFFSET_PRESSURE_DELTA_CAL_COUNT + 1) /*37*/

#define SEC_TS_NVM_LAST_BLOCK_OFFSET			SEC_TS_NVM_OFFSET_PRESSURE_STRENGTH_INDEX
#define SEC_TS_NVM_LAST_BLOCK_SIZE			1
...
struct sec_ts_data {
	...
	unsigned char pressure_cal_index;
